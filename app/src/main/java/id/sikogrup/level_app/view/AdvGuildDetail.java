...
public class AdvGuildDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adv_guild_detail);
        ...
        buttonListGuideBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AdvGuildDetail.this, "Under Construction", Toast.LENGTH_SHORT).show();
...
//                return;
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, AdvGuildDetail.class);
    }
}
