...
public class AdapterGuildRecyclerView extends RecyclerView.Adapter<AdapterGuildRecyclerView.ViewHolder> {
    private ArrayList<Guild> daftarGuild;
    private Context context;

    public AdapterGuildRecyclerView(ArrayList<Guild> daftarGuild, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, GmGuildDetail.class);
